...
$id = $_GET['id'];
$detail = query("SELECT * FROM brand JOIN laptop ON brand.brand = laptop.merek WHERE brand = '$id'");
...
<div id="box-search">
  <div class="detail">
  <div class="container">
    <p class="detailNamaLaptop"><a href="brand.php">Brand</a>/<?= $detail[0]['brand'] ?></p>
    <div class="row">
